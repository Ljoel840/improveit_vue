    ...
    <section>
        <div class="container-fluid">
                ...
                <div class="row mt-30" style="color:black" v-if="deportistas">
                    <div class="col-md-3 col-sm-6" v-for="atleta in deportistas" :key="atleta.id" style="padding-top:20px">
                        <div class="box16">
                            ...
                            <div class="box-content">
                                ...
                                <ul class="social">
                                    <router-link class="botonCorreo" :to="{ name:'detalleDeportista', params:{ atletaSeleccionado:atleta}}">Ver más</router-link>
                                </ul>
                            </div>
                        </div>
                    </div>
